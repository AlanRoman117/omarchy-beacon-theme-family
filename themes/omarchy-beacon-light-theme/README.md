...
You want a light theme that is genuinely readable and you do not have a colour vision deficiency.
...
| accent | `#003A77` | 10.66:1 | +92 |
| orange (not an ANSI slot) | `#8D3F00` | 7.01:1 | +81 |

| ANSI | Hex | Contrast vs background |
|---|---|---|
| red | `#62000A` | 13.09:1 |
| green | `#003D18` | 11.87:1 |
| yellow | `#664500` | 8.26:1 |
| blue | `#003A77` | 10.66:1 |
| magenta | `#781A61` | 9.41:1 |
| cyan | `#005F6B` | 7.00:1 |

- **Lowest contrast of any colour in the palette: 7.00:1.** The WCAG AAA
...
- Active window border against the desktop: 10.66:1 (WCAG 1.4.11 asks 3:1)
...
|---|---|---|
| normal **(tuned for this)** | blue / cyan | 0.123 |
| protan | blue / magenta | 0.040 |
| deutan | red / green | 0.026 |
| tritan | green / blue | 0.059 |
